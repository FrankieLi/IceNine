...
//
//---------------------------------------------------------
Int CMic::GetLeftMostVertex(const SVoxel & v ) const
{
...
//
//---------------------------------------------------------
bool CMic::ReadFileToBuf(const string &filename)
{
  ifstream infile;
  ...
  if ( fread( pBuffer, nBufferSize, 1, pFile ) <= 0 ){
    fclose( pFile );
    cerr << "[CMic::ReadFileToBuf]: File read error " << filename << endl;
    return false;
  }
...
//
//---------------------------------------------------------
void CMic::SetNumCol( Int newNumCols )
{
  nNumCols = newNumCols;
}
...
//  SetVoxelList
//---------------------------------------------------------
void CMic::SetVoxelList(const vector<SVoxel> & oVoxels)
{
  oVoxelList = oVoxels;
}
...
//  AddVoxel
//---------------------------------------------------------
void CMic::AddVoxel(const SVoxel & oVoxel)
{
...
//---------------------------------------------------------
void CMic::SetInitialSideLength(Float fSideLength)
{
...
//  GetMinSideLength
//---------------------------------------------------------
Float CMic::GetMinSideLength() const
{
...
// experimental peaks
//---------------------------------------------------------
bool CMic::Read( const string &filename )
{
...
//
//---------------------------------------------------------
Float CMic::GetInitialSideLength() const
{
